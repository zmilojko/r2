...
class ScansControllerTest < ActionController::TestCase
  ...
  test "should create scan" do
    assert_difference('Scan.count') do
      post :create, scan: { content: @scan.content, last_visited: @scan.last_visited, site_id: @scan.site_id, url: @scan.url }
    end
  ...
  test "should update scan" do
    patch :update, id: @scan, scan: { content: @scan.content, last_visited: @scan.last_visited, site_id: @scan.site_id, url: @scan.url }
    assert_redirected_to scan_path(assigns(:scan))
  end
